  ...
  <div class="hidden w-28 bg-indigo-700 overflow-y-auto md:block">
    <div class="w-full py-6 flex flex-col items-center">
      ...
      <div class="flex-1 mt-6 w-full px-2 space-y-1">
        ...
        <a @click="task" v-bind:class="{'bg-indigo-800': tasks === true, '': tasks === false}" class="text-indigo-100 hover:bg-indigo-800 hover:text-white group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
...
<script>
import Task from "../components/Portal/Task";
